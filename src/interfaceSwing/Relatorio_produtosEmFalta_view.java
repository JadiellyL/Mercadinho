 ...
 * @author jade
 */
public class Relatorio_produtosEmFalta_view extends javax.swing.JFrame {

    /**
     * Creates new form Relatorio_produtosEmFalta_view
     */
    public Relatorio_produtosEmFalta_view() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Produtos com quantidade baixa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Relatorio_produtosEmFalta_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Relatorio_produtosEmFalta_view().setVisible(true);
            }
        });
    }
